// ============================================================================
// BACKUP DO CÓDIGO ORIGINAL FORNECIDO PELO USUÁRIO
// Data do backup: 14/09/2026
// ============================================================================

// Pegue sua chave grátis em: https://aistudio.google.com/
...
function chamarGemini(disciplina, topico) {
  // Se quiser usar o Pro, troque flash por pro: gemini-1.5-pro
...
Retorne ESTRITAMENTE um JSON puro (sem marcação de markdown \`\`\`json em volta) no seguinte formato:
{
  "palavras_do_dia": [
  ...
  "contexto_visual": "Texto formatado explicando o conceito por lógica/decomposição, sem fórmulas.",
